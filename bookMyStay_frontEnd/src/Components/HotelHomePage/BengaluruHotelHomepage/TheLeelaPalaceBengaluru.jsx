...
function SouthernStarMysore() {
  const [hotelName, setHotelName] = useState('');
  const [description, setDescription] = useState('');

  useEffect(() => {
    fetchHotelDetails('The Leela Palace'); // Adjust the hotel name here
  }, []);
  ...
  return (
    <div>
      ...
      <Container className='location' style={{border:"1px solid black", width:"52%",alignContent:"left"}}>
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3888.1798340083246!2d77.64586117454641!3d12.960341715126093!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae14067cca9bdd%3A0x111bbe37cc24e71a!2sThe%20Leela%20Palace%20Bengaluru%20-%20Garden%20City&#39;s%20Only%20Modern%20Palace%20Hotel!5e0!3m2!1sen!2sin!4v1714334172073!5m2!1sen!2sin" width="600" height="450"style={{border:"0",allowfullscreen:"", loading:"lazy", referrerpolicy:"no-referrer-when-downgrade"}}></iframe>
        </Container> <br />
    </div>
  );
}

export default  SouthernStarMysore;
