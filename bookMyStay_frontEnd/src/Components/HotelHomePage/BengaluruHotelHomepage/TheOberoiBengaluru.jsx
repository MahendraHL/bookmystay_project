...
function TheOberoisBengaluru() {
  const [hotelName, setHotelName] = useState('');
  const [description, setDescription] = useState('');

  useEffect(() => {
    fetchHotelDetails('The Oberoi Bangalore'); // Adjust the hotel name here
  }, []);
  ...
  return (
    <div>
      ...
      <Container className='location' style={{border:"1px solid black", width:"52%",alignContent:"left"}}>
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3887.9725107069544!2d77.61582757454659!3d12.973610014835252!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae16835c3ada19%3A0x7065f59042b7b2db!2sThe%20Oberoi%2C%20Bengaluru!5e0!3m2!1sen!2sin!4v1714335574496!5m2!1sen!2sin" width="600" height="450" style={{ border: "0", allowfullscreen: "", loading: "lazy", referrerpolicy: "no-referrer-when-downgrade" }}></iframe>
        </Container> <br />
    </div>
  );
}

export default  TheOberoisBengaluru;
