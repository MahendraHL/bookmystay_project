...
function GrandMercureMysuru() {
  const [hotelName, setHotelName] = useState("");
  const [description, setDescription] = useState("");

  useEffect(() => {
    fetchHotelDetails("Grand Mercure Mysore"); // Adjust the hotel name here
  }, []);
  ...
  return (
    <div>
      ...
      >
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3888.6714657411685!2d77.62518467454592!3d12.928824715815754!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae145e9b6fb02b%3A0x320b03cd74e611e2!2sGrand%20Mercure%20Bangalore!5e0!3m2!1sen!2sin!4v1714329417651!5m2!1sen!2sin"
          width="600"
          height="450"
          style={{
            border: "0",
...
export default GrandMercureMysuru;
